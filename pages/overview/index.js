    ...
    <div className="header">
      <div className="h-12 bg-[#FFFFFF]/90  border-b-2 border-gray-100 flex items-center justify-between px-10 text-[#939393]">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[0.65rem] font-bold">24-03 Original New Page</p>
        </div>
        <p className="text-[0.75rem] ml-[-160px] font-bold">24-03 Original New</p>
        <p className="text-xl">
          <Image src={bell} height={35} width={35} alt="bell__icon" />
        </p>
      </div>

      <div className=" p-3 flex justify-between px-[3rem]  flex-wrap sub__header">
        <div className=" flex  space-x-4 text-[.9rem]">
          <p>Complete overview of all the suppliers.</p>
        </div>
        <div>
          <ul className=" flex space-x-5 text-[.9rem]">
            <li className="px-4 rounded-md py-2 flex">
            <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="20.5" cy="12" r="6" stroke="#A1A5B0" stroke-width="1.5"/>
<ellipse cx="20.5" cy="12" rx="3" ry="5" stroke="#A1A5B0" stroke-width="1.5"/>
<path d="M14.5 12H26.5" stroke="#A1A5B0" stroke-width="1.5" stroke-linecap="round"/>
</svg>

                <div className=" ml-2">Webpage</div></li>
            <li className="px-4 rounded-md py-2">Close List </li>
            <li className="px-4 rounded-md py-2">Edit </li>
